...
function parseViewElement(element) {
  ...
  var viewInstance = createDynamicViewInstance(expression, viewAttributes, hooks);
...
function parseViewExpression(expression) {
  ...
  var viewInstance = createDynamicViewInstance(nameExpression, viewAttributes, hooks);
  parseNode.content.push(viewInstance);
}
